...
#define MSJ_ERROR_ENTRADA_INVALIDA "invalid input"
#define MSJ_ERROR_FILE_INPUT_DEMASIADO_LARGO  "input file's name is too long"
#define MSJ_ERROR_FILE_OUTPUT_DEMASIADO_LARGO "output file's name is too long"
#define MSJ_ERROR_ARGUMENTO_INVALIDO "invalid argument"
...
#define MSJ_ERROR_MEMORIA_INSUFICIENTE_ARCHIVO "there is not enough memory to load the program"
